...
let decimal = 10;
let hex = 0xa; // 16진수 16진수 a는 10진수와 동일함
let dinary = 0b1010; // 2진수 
let octal = 0o12; // 8진수
...
// 타입은 명시적으로 지정
const private = { job: 'student', time: 60 };
let job = 'student';
let studyTime = 10;
